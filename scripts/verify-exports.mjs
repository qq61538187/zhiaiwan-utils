...
const extraEntries = Object.keys(pkg.exports).filter((key) => !(key in expectedExports))
if (extraEntries.length > 0) {
  throw new Error(`Unexpected exports entries found: ${extraEntries.join(', ')}`)
}

console.info(`[verify-exports] Verified exports entries for ${Object.keys(expectedExports).length} paths.`)
